...
import onjava.ProcessFiles.Strategy;
import onjava.atunit.ClassNameFinder;
			...
			try {
				if(creator == null)
					if(!Modifier.isPublic(testClass.getDeclaredConstructor().getModifiers())){
						System.out.println("Error: " + testClass +" no-arg constructor must be pulbic");
						System.exit(1);
					}
			} catch (NoSuchMethodException |
					SecurityException e) {
				//Synthesiezed no-arg constructor; OK
			}
